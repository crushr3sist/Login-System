...
def admin_init():
    ...
    display = [showSprite(registerBTN),showSprite(editTableBTN),showSprite(viewTBBTN),showLabel(edit_table),showLabel(Register),showLabel(viewDatabase),showLabel(main_page_message)]
